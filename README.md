...
Tools: Microsoft Excel (Pivot Tables, Pivot Charts, Power Query, Advanced Formulas, Slicers, Data Modeling)

Project Overview

Developed an end-to-end HR Analytics Dashboard to monitor workforce health, attrition risk, diversity, and organizational structure. The dashboard consolidates multi-year HR data into a single decision-support view for HR leadership, enabling proactive talent and capacity planning across departments and reporting managers.
...
![image alt](https://github.com/MrMonsterAnalyst/HR-Analytics-Team-Dashboard-Excel/blob/8aab784e70c7bc59f02ddfd597ef68732191e368/HR%20Dashboard.png)
